<template>
    ...
    -->
			<div
				...
				@click="toggle()"
				:class="[open ? 'w-full' : 'max-w-0']"
			></div>

			<div
				class="fixed inset-0 flex z-40 duration-300"
				:class="[open ? 'w-80' : 'w-0']"
			>
				<!--
      ...
      -->
        ...
        -->
              ...
              -->
				...
				<!-- <div v-if="open" @click="toggle()" class="flex-shrink-0 w-14 bg-transparent" aria-hidden="true"> -->
