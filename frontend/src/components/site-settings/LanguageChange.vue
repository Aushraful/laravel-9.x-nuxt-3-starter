...
<template>
	<div>
		<Listbox v-model="local" as="div" class="relative flex items-center">
			...
			<ListboxOptions
				class="absolute bottom-full md:bottom-auto md:top-full md:right-0 z-[999] p-1 border dark:border-gray-600 mt-2 w-40 overflow-hidden rounded-lg bg-white text-sm font-semibold text-gray-700 shadow-lg shadow-gray-300 outline-none dark:bg-gray-800 dark:text-white dark:shadow-gray-500 dark:ring-0"
			>
				<NuxtLink
